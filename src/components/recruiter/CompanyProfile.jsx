...
import { createCompany, getCompany } from "@/lib/actions/company";
...
export default function CompanyProfile() {
  ...
  useEffect(() => {
    ...
    async function loadCompany() {
      ...
      const data = await getCompany(user.user.id);
      setCompany(data);
      setLoading(false);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    const newCompanyData = {
      _id: company?._id || crypto.randomUUID(),
      name: companyName,
      websiteUrl,
    ...
    const updatedCompany = await getCompany(user.user?.id);
    ...
    return (
      <div className="rd-company-shell">
        <PageHeader
          variant="recruiter"
          title="My Company"
          description="Loading your company profile..."
        />
      </div>
    );
  }
        ...
        <div className="rd-panel rd-company-view">
            ...
            <div className="rd-company-identity">
              ...
              <div>
                <div className="rd-company-title-row">
                  ...
                  <span
                    className={`rd-status-badge ${company.status?.toLowerCase()}`}
                  >
                    {company.status}
                  </span>
                </div>
          ...
          <div className="rd-company-meta">
            {[
              ...
              ["Team Size", company.employeeCount],
            ].map(([label, value]) => (
        ...
        <div className="rd-company-form-wrap">
          ...
          <form className="rd-modal-form" onSubmit={handleSubmit}>
            <div className="rd-field">
              ...
              />
              {errors.companyName && (
                <p className="rd-field-error">{errors.companyName}</p>
              )}
            </div>
            ...
            <div className="rd-field">
              ...
              {errors.websiteUrl && (
                <p className="rd-field-error">{errors.websiteUrl}</p>
              )}
            </div>
            ...
            <div className="rd-field">
              ...
              {errors.location && (
                <p className="rd-field-error">{errors.location}</p>
              )}
            </div>
            ...
            <CompanySelect
              ...
              defaultKey={company?.employeeCount || "1-10"}
